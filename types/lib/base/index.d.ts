export type TraceContext = import("../orchestrator").TraceContext;
export type CdsEntity = import("../orchestrator").CdsEntity;
export type SoapHeaderObject = import("../orchestrator").SoapHeaderObject;
/**
